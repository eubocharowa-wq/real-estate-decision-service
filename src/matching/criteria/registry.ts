...
const definitions = [
  ...
  define({
    ...
    aliases: ["financing.initial_payment_max"],
    valueType: "money",
    supportsTolerance: true,
    supportsSoftCurve: true,
  }),
  define({
    ...
    aliases: ["financing.zero_initial_payment"],
    valueType: "boolean",
  }),
  define({
    ...
    aliases: ["financing.monthly_payment_max"],
    valueType: "money",
    supportsTolerance: true,
    supportsSoftCurve: true,
  }),
  define({
    ...
    aliases: ["family_mortgage", "financing.program_type"],
  ...
  define({
    ...
    aliases: ["property.floor.is_first"],
